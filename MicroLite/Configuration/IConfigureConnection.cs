...
namespace MicroLite.Configuration
{
    ...
    public interface IConfigureConnection : IHideObjectMethods
    {
        ...
        [System.Obsolete("This method has been replaced and will be removed in MicroLite 4.0.0, please call Configure.Fluently().ForConnection(connectionName, \"MicroLite.Dialect.MsSqlDialect\") instead.", error: false)]
