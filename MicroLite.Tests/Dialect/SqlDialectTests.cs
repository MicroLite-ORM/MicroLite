namespace MicroLite.Tests.Dialect
{
    ...
    public class SqlDialectTests : UnitTest
    {
        ...
        public void InsertInstanceQueryForIdentifierStrategyAssigned()
        {
            ...
            Assert.Equal("INSERT INTO Sales.Customers (Created,CreditLimit,DateOfBirth,Id,Name,CustomerStatusId,Version,Website) VALUES (?,?,?,?,?,?,?,?)", sqlQuery.CommandText);
            ...
            Assert.Equal("INSERT INTO Sales.Customers (Created,CreditLimit,DateOfBirth,Id,Name,CustomerStatusId,Version,Website) VALUES (?,?,?,?,?,?,?,?)", sqlQuery.CommandText);
            Assert.Equal(8, sqlQuery2.Arguments.Count);
            ...
            Assert.Equal(customer.Version, sqlQuery2.Arguments[6].Value);

            Assert.Equal(DbType.String, sqlQuery2.Arguments[7].DbType);
            Assert.Equal("http://microliteorm.wordpress.com/about", sqlQuery2.Arguments[7].Value);
        }
        ...
        public void InsertInstanceQueryForIdentifierStrategyDbGenerated()
        {
            ...
            Assert.Equal("INSERT INTO Sales.Customers (Created,CreditLimit,DateOfBirth,Name,CustomerStatusId,Version,Website) VALUES (?,?,?,?,?,?,?)", sqlQuery.CommandText);
            ...
            Assert.Equal(DbType.Int32, sqlQuery2.Arguments[5].DbType);
            Assert.Equal(customer.Version, sqlQuery2.Arguments[5].Value);
        ...
        public void InsertInstanceQueryForIdentifierStrategySequence()
        {
            ...
            Assert.Equal("INSERT INTO Sales.Customers (Created,CreditLimit,DateOfBirth,Name,CustomerStatusId,Version,Website) VALUES (?,?,?,?,?,?,?)", sqlQuery2.CommandText);
            Assert.Equal(7, sqlQuery2.Arguments.Count);
        ...
        public void SelectByIdentifierQuery()
        {
            ...
            Assert.Equal("SELECT Created,CreditLimit,DateOfBirth,Id,Name,CustomerStatusId,Updated,Version,Website FROM Sales.Customers WHERE (Id = ?)", sqlQuery.CommandText);
            Assert.Equal(1, sqlQuery.Arguments.Count);
            ...
            Assert.Equal("SELECT Created,CreditLimit,DateOfBirth,Id,Name,CustomerStatusId,Updated,Version,Website FROM Sales.Customers WHERE (Id = ?)", sqlQuery2.CommandText);
            Assert.Equal(1, sqlQuery2.Arguments.Count);
        ...
        public void UpdateInstanceQuery()
        {
            ...
            Assert.Equal("UPDATE Sales.Customers SET CreditLimit = ?,DateOfBirth = ?,Name = ?,CustomerStatusId = ?,Updated = ?,Version = ?,Website = ? WHERE (Version = ?) AND (Id = ?)", sqlQuery.CommandText);
            ...
            Assert.Equal(DbType.Int32, sqlQuery2.Arguments[5].DbType);
            Assert.Equal(customer.Version + 1, sqlQuery2.Arguments[5].Value);

            Assert.Equal(DbType.String, sqlQuery2.Arguments[6].DbType);
            Assert.Equal("http://microliteorm.wordpress.com/about", sqlQuery2.Arguments[6].Value);

            Assert.Equal(DbType.Int32, sqlQuery2.Arguments[7].DbType);
            Assert.Equal(customer.Version, sqlQuery2.Arguments[7].Value);

            Assert.Equal(DbType.Int32, sqlQuery2.Arguments[8].DbType);
            Assert.Equal(customer.Id, sqlQuery2.Arguments[8].Value);
            ...
            sqlQuery = mockSqlDialect.Object.BuildUpdateSqlQuery(ObjectInfo.For(typeof(CustomerCustomVersion<ushort>)), customerShort);
            ...
            sqlQuery = mockSqlDialect.Object.BuildUpdateSqlQuery(ObjectInfo.For(typeof(CustomerCustomVersion<ulong>)), customerLong);
            ...
            sqlQuery = mockSqlDialect.Object.BuildUpdateSqlQuery(ObjectInfo.For(typeof(CustomerCustomVersion<DateTime>)), customerDateTime);
        ...
        public void UpdateWithoutVersionInstanceQuery()
        {
            ...
            var sqlQuery = mockSqlDialect.Object.BuildUpdateSqlQuery(ObjectInfo.For(typeof(CustomerWithoutVersion)), customer);

            Assert.Equal("UPDATE Sales.CustomerWithoutVersions SET CreditLimit = ?,DateOfBirth = ?,Name = ?,CustomerStatusId = ?,Updated = ?,Website = ? WHERE (Id = ?)", sqlQuery.CommandText);
            Assert.Equal(7, sqlQuery.Arguments.Count);
            ...
            // Do a second query to check that the caching doesn't cause a problem.
            customer = new CustomerWithoutVersion
            {
                Created = new DateTime(2012, 08, 13),
                CreditLimit = 6250.00M,
                DateOfBirth = new DateTime(1984, 3, 11),
            ...
            var sqlQuery2 = mockSqlDialect.Object.BuildUpdateSqlQuery(ObjectInfo.For(typeof(CustomerWithoutVersion)), customer);
