namespace MicroLite.Tests.Dialect
{
    ...
    public class SQLiteDialectTests
    {
        ...
        public void DeleteQueryForInstance()
        {
            ...
            Assert.AreEqual("DELETE FROM [Customers] WHERE [Customers].[CustomerId] = @p0", sqlQuery.CommandText);
        ...
        public void InsertQueryForAssignedInstance()
        {
            ...
            Assert.AreEqual("INSERT INTO [Customers] ([Customers].[CustomerId], [Customers].[Name], [Customers].[StatusId]) VALUES (@p0, @p1, @p2)", sqlQuery.CommandText);
            Assert.AreEqual(customer.Id, sqlQuery.Arguments[0]);
        ...
        public void InsertQueryForIdentityInstance()
        {
            ...
            Assert.AreEqual("INSERT INTO [Customers] ([Customers].[Created], [Customers].[DoB], [Customers].[Name], [Customers].[StatusId]) VALUES (@p0, @p1, @p2, @p3)", sqlQuery.CommandText);
 ...
 [Customers].[Name] ASC", new object[] { CustomerStatus.Active });
        ...
        public void SelectQuery()
        {
            ...
            Assert.AreEqual("SELECT [Customers].[Created], [Customers].[DoB], [Customers].[CustomerId], [Customers].[Name], [Customers].[StatusId], [Customers].[Updated] FROM [Customers] WHERE [Customers].[CustomerId] = @p0", sqlQuery.CommandText);
            Assert.AreEqual(identifier, sqlQuery.Arguments[0]);
        }
        ...
        public void UpdateQuery()
        {
            ...
            Assert.AreEqual("UPDATE [Customers] SET [Customers].[DoB] = @p0, [Customers].[Name] = @p1, [Customers].[StatusId] = @p2, [Customers].[Updated] = @p3 WHERE [Customers].[CustomerId] = @p4", sqlQuery.CommandText);
