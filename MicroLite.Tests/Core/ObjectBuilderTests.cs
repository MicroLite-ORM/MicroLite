namespace MicroLite.Tests.Core
{
    ...
    public class ObjectBuilderTests : IDisposable
    {
        ...
        public void BuildInstancePropertyValueIsSetToValueForNullableInt()
        {
            ...
            mockDataReader.Setup(x => x.GetInt32(0)).Returns(1235);
        ...
        public void BuildInstancePropertyValuesAreSetCorrectly()
        {
            ...
            mockDataReader.Setup(x => x.GetInt32(0)).Returns(123242);
            mockDataReader.Setup(x => x.GetString(1)).Returns("Joe Bloggs");
            mockDataReader.Setup(x => x.GetDateTime(2)).Returns(new DateTime(1980, 7, 13));
            mockDataReader.Setup(x => x.GetValue(3)).Returns(1);
        ...
        [Fact(Skip = "Ignored whilst we're changing how ObjectBuilder works")]
